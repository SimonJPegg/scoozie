...
final class Hive2Action(override val name: String,
  ...
  override def properties: Map[String, String] =
    ...
    Map(scriptNameProperty -> scriptName, scriptLocationProperty -> scriptLocation, jdbcUrlProperty -> jdbcUrl) ++
